					...
					<div class="top-nav">
						<div class="wrap">
							<ul>
								...
								<li class="active"><a href="DisplayNews">News</a></li>
		...
		<div class="wrap">
			<div class="services">
				<div class="service-content">
					<h3>News Updates 2016</h3><br>
					<ul>
					<c:forEach items="${newsList}"  var="news">
						<li><span><c:out value="${news.getId()}"/>.</span></li>
						<li><p style="color: #007DAD" style="font-size:50px">
								<c:out value="${news.getSubject()}"/>
							</p>
							<p><c:out value="${news.getContent()}"/>.<br>
							<br></p></li>
