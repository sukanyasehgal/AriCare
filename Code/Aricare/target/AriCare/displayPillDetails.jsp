<!--  ***********************************************************************
	  ...
	  File Name	            :     displayPillDetails.jsp
	  Principal Author      	: GR_TH3_03
	  Subsystem Name        :
	  Module Name           	:  display pill details
	  Date of First Release 	:  09-05-2016
	  Author			:          GR_TH3_03
	  Description           	:  displaying pill information to patient
	...
	<div style="padding: 21em 10em 7em 0em">
		...
		<span style="float: center">
			<table class="gridtable" ;  width="800" ;>
				...
				<tr>
					<th style="text-align: center; font-weight: bold;"><b>Pill Name</b></th>
					<th style="text-align: center; font-weight: bold;"><b>Start Date</b></th>
					<th style="text-align: center; font-weight: bold;"><b>End Date</b></th>
					<th style="text-align: center; font-weight: bold;"><b>Timing</b></th>
					<th style="text-align: center; font-weight: bold;"><b>Dosage</b></th>
				</tr>


				<%
				    LoginBean user=(LoginBean)session.getAttribute("currentSessionUser");
				DisplayPillInterface obj=new DisplayPillDAO();
				request.setAttribute("pillList",obj.displayPillDetails(user)); %>
				
				 <c:forEach items="${pillList}"  var="pill">

                                <tr>

                                        <td style="text-align: center"><c:out value="${pill.getPill_name()}"/></td>

                                        <td style="text-align: center"><c:out value="${pill.getStart_date()}"/></td>

                                        <td style="text-align: center"><c:out value="${pill.getEnd_date()}"/></td>

                                        <td style="text-align: center"><c:out value="${pill.getDosage_time()}"/></td>

                                        <td style="text-align: center"><c:out value="${pill.getDosage()}"/></td>
