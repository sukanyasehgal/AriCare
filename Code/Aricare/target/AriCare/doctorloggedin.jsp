<!--  ***********************************************************************
	  ...
	  File Name	            :    doctorloggedin.jsp
	  Principal Author      	: GR_TH3_03
	  Subsystem Name        :
	  Module Name           	:  doctor login
	  Date of First Release 	:  11-05-2016
	  Author			:          GR_TH3_03
	  Description           	:  displaying page when doctor logins 
			...
			<div class="content">
					...
					<style>
							...
							<table style="width:100;">
								<tr><td><a href="doctorProfile.jsp">My Profile</a></td></tr>
								<tr><td><a href="doctorTodayAppointmentDetails.jsp">Today's Appointments</a></td></tr>	
								<tr><td><br></td></tr>	
								<tr><td><br></td></tr>
								<tr><td><br></td></tr>		
							</table>
